...
class Client implements RequestableInterface {
    ...
    public function response()
    {
        ...
        return array_merge($this->response->json(), ['records' => $this->response->getHeader('x-records'),
                                                    'pages' => $this->response->getHeader('x-pages'),
                                                    'page' => $this->response->getHeader('x-page')]);
