...
use Mockery as m;
use Damienpirsy\Teamwork\Factory;
...
class FactoryTest extends PHPUnit_Framework_TestCase {
    ...
    {
        parent::setUp();
        $this->requestable = m::mock('Damienpirsy\Teamwork\Contracts\RequestableInterface');
    }
    ...
    public function test_that_it_returns_new_account_object()
    {
        ...
        $this->assertInstanceOf('Damienpirsy\Teamwork\Account', $factory->account());
    }

    /**
     * @group factory
     * @expectedException Damienpirsy\Teamwork\Exceptions\ClassNotCreatedException
     */
